...
export const metadata: Metadata = {
  ...
  description:
    'Refined beauty, skin, body, and aesthetic treatments within the 28 collective in Tribeca. Natural enhancement delivered with precision and an artist’s eye.',
